...
/**
 * Description of a created &#x27;Event&#x27; object
 */
@Schema(description = "Description of a created 'Event' object")
@Validated
...
public class EventCreated   {
  ...
  public EventCreated name(String name) {
    this.name = name;
    return this;
  }
  ...
  public EventCreated startDateTime(OffsetDateTime startDateTime) {
  ...
  public EventCreated endDateTime(OffsetDateTime endDateTime) {
  ...
  public EventCreated place(String place) {
    this.place = place;
    return this;
  }
  ...
  public EventCreated price(Float price) {
    this.price = price;
    return this;
  }
  ...
  public EventCreated description(String description) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EventCreated eventCreated = (EventCreated) o;
    return Objects.equals(this.name, eventCreated.name) &&
        Objects.equals(this.startDateTime, eventCreated.startDateTime) &&
        Objects.equals(this.endDateTime, eventCreated.endDateTime) &&
        Objects.equals(this.place, eventCreated.place) &&
        Objects.equals(this.price, eventCreated.price) &&
        Objects.equals(this.description, eventCreated.description);
  }
