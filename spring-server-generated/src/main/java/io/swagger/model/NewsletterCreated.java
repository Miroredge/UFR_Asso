...
/**
 * Description of a created &#x27;Newsletter&#x27; object
 */
@Schema(description = "Description of a created 'Newsletter' object")
@Validated
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.SpringCodegen", date = "2022-12-12T07:32:15.929Z[GMT]")


public class NewsletterCreated   {
  @JsonProperty("title")
  ...
  public NewsletterCreated title(String title) {
    this.title = title;
    return this;
  }
  ...
  public NewsletterCreated description(String description) {
  ...
  public NewsletterCreated body(String body) {
    this.body = body;
    return this;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NewsletterCreated newsletterCreated = (NewsletterCreated) o;
    return Objects.equals(this.title, newsletterCreated.title) &&
        Objects.equals(this.description, newsletterCreated.description) &&
        Objects.equals(this.body, newsletterCreated.body);
  }
  ...
  public String toString() {
    ...
    sb.append("class NewsletterCreated {\n");
