...
public class UsersPseudoBody extends User  {
  @JsonProperty("password")
  private String password = null;

  public UsersPseudoBody password(String password) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UsersPseudoBody usersPseudoBody = (UsersPseudoBody) o;
    return Objects.equals(this.password, usersPseudoBody.password) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class UsersPseudoBody {\n");
