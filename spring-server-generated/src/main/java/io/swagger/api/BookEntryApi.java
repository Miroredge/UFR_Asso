...
@Validated
public interface BookEntryApi {

    @Operation(summary = "Delete a `BookEntry`", description = "This operation allows to delete a `BookEntry`, identified by its unique identifier **bookEntryId**", security = {
...
"Organisation_Treasurer"        })    }, tags={ "BookEntry" })
    ...
    @RequestMapping(value = "/book-entry/{bookEntryId}",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Errors> deleteBookEntry(@Parameter(in = ParameterIn.HEADER, description = "Network location of the URI" ,required=true,schema=@Schema()) @RequestHeader(value="Host", required=true) String host, @Size(min=1,max=8) @Parameter(in = ParameterIn.PATH, description = "Technical Unique ID of the `BookEntry` operation (Base36 encoding) (https://en.wikipedia.org/wiki/Base36)", required=true, schema=@Schema()) @PathVariable("bookEntryId") String bookEntryId);


    @Operation(summary = "Get a single `BookEntry`", description = "This operation allows to get a `BookEntry`, identified by its unique identifier **bookEntryId**", security = {
        @SecurityRequirement(name = "OauthSecurity", scopes = {
            "All",
"Application_Admin",
"Organisation_Admin",
...
"Organisation_Treasurer"        })    }, tags={ "BookEntry" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Ressource 'BookEntry' found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = BookEntryFound.class))),
    ...
    @Operation(summary = "Overwrite a single `BookEntry`", description = "This operation allows to overwrite a `BookEntry`, identified by its unique identifier **bookEntryId**", security = {
        @SecurityRequirement(name = "OauthSecurity", scopes = {
            "All",
"Application_Admin",
"Organisation_Admin",
