...
public interface AuthenticateApi {
    ...
    @Operation(summary = "Authenticate the user", description = "This operation allows the 'User' to authenticate using its LOGIN and PASSWORD", security = {
...
"Organisation_Treasurer"        })    }, tags={ "Authentication" })
    @ApiResponses(value = { 
        @ApiResponse(responseCode = "200", description = "Ressource 'Token' created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TokenCreated.class))),
    ...
    ResponseEntity<TokenCreated> authenticateUser(@Parameter(in = ParameterIn.HEADER, description = "Network location of the URI" ,required=true,schema=@Schema()) @RequestHeader(value="Host", required=true) String host, @Parameter(in = ParameterIn.DEFAULT, description = "User credentials", required=true, schema=@Schema()) @Valid @RequestBody AuthenticateBody body);
