...
INSERT INTO `ufr_asso`.`usr_has_aso_and_rol` (USR_ROW_IDT, ASO_ROW_IDT, ROL_ROW_IDT, CRE_ID, CRE_DAT, UPD_ID, UPD_DAT) VALUES
     ...
     ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0002'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0003'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0003'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0004'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0004'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0004'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0005'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0005'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0005'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0005'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0006'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0006'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0006'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0006'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0007'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0007'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0007'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0007'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0008'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0008'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0008'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0008'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0009'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000A'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000A'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000F'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000G'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000G'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000H'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000H'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000I'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000I'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000J'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000J'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000K'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'CANDIDATE'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000L'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '73282932000074'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'REFUSED'  ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000N'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000O'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000O'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000P'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000P'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000P'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Q'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Q'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Q'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Q'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000R'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000R'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000R'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000R'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000S'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000S'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000S'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000S'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000T'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000T'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000T'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000T'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000U'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000V'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000V'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000W'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000W'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000W'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000X'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000X'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000X'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Y'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Y'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Y'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Z'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Z'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z000Z'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0010'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0011'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0011'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0012'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0012'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0013'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0013'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0014'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0014'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0015'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'CANDIDATE'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0016'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = 'MONACOCONFO001'         ),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'REFUSED'  ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0017'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0017'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0017'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0018'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0018'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0018'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0018'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0019'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0019'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0019'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0019'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0019'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001A'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001A'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001A'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001A'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001A'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001B'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001B'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001C'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001C'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001D'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001D'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001E'),null                                                                            ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001E'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'VICE-PRESIDENT'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001F'),null                                                                            ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001F'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001F'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001F'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001F'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'SECRETARY'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001G'),null                                                                            ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001G'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001G'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001G'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'MEMBER'   ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001G'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'TREASURER'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001H'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001H'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001H'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'CANDIDATE'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001I'),null                                                                       ,(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'APP_ADMIN'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001I'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '1_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'ADMIN'    ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z001I'),(SELECT ROW_IDT FROM `ufr_asso`.`aso` WHERE SIR_NBR = '2_MIX_STUD_AND_NOT_STUD'),(SELECT ROW_IDT FROM `ufr_asso`.`rol` WHERE NAM = 'REFUSED'  ),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
;
...
INSERT INTO `ufr_asso`.`usr_has_evt` (USR_ROW_IDT, EVT_ROW_IDT, CRE_ID, CRE_DAT, UPD_ID, UPD_DAT) VALUES
     ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0001'),(SELECT ROW_IDT FROM `ufr_asso`.`evt` WHERE EVT_ID = 'Z0001'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0002'),(SELECT ROW_IDT FROM `ufr_asso`.`evt` WHERE EVT_ID = 'Z0002'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0003'),(SELECT ROW_IDT FROM `ufr_asso`.`evt` WHERE EVT_ID = 'Z0003'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
,    ((SELECT ROW_IDT FROM `ufr_asso`.`usr` WHERE USR_ID = 'Z0004'),(SELECT ROW_IDT FROM `ufr_asso`.`evt` WHERE EVT_ID = 'Z0004'),'INIT_SCRIPT', NOW(), 'INIT_SCRIPT', NOW())
